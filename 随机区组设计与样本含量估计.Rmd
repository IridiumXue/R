...
观察三种饲料对小鼠体重的影响情况，研究者希望能有80%的把握发现三种饲料对增重的真实影响。
三种饲料的增重均数分别为61.4,72.2,68.7，标准差分别为10.7,12.3,11.8，合并标准差为11.6。

样本含量估计以及研究对象随机分组（随机区组设计，三只体重相同或相近的小鼠作为一个区组，然后每个区组内将3只小鼠随机分配到不同组别）
