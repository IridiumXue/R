...
比较药物A和药物B在糖尿病治疗中的效果，以空腹血糖测量值及空腹血糖疗效作为主要疗效指标，希望有80%的把握发现两种药物的真实差异，以往研究获得两组空腹血糖均值和标准差分别为8.06±1.82和7.23±1.52，据此计算出合并拼方差为2.81，标准差为1.68，血糖疗效的两组有效率分别为71%和83%
